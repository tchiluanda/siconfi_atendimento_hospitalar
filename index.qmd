...
[^4]: Tal como os dados sobre gastos informados logo na primeira seção do texto, aqui também utilizamos as informações vindas do SICONFI. Os valores apresentados correspondem cálculos realizados sobre os valores pagos para todos os municípios com exceção de Brasília em que usamos o valor liquidado.
