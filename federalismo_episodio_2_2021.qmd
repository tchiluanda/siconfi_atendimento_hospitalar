...
-   Saída fraca: formado por 1020 municípios, [São Bento-MA](https://cidades.ibge.gov.br/brasil/ma/sao-bento/panorama) é o que melhor caracteriza esse grupo. Para essa cidade, O percentual de saída é 31,4% e o de entrada é 6,2%.
...
Provavelmente você está lendo esse texto a partir de um painel produzido pela Secretaria do Tesouro Nacional. Além desse material, o painel conta com páginas que permitem localizar os municípios dentro dos quadros analíticos explorados ao longo do texto. Assim como no texto, todos os dados do painel referem-se à amostra de 10% do total das internações ocorridas no Brasil em 2021. É possível também que, com a evolução das sugestões de usuários, novas páginas sejam acrescentadas sem necessariamente haver análises feitas pela equipe da STN. Convidamos o leitor a navegar por entre as abas disponibilizadas, fazer filtros, baixar dados e capturar gráficos para outras ressignficações dos dados sobre atendimentos hospitalares no Brasil e suas relações com execuções orçamentárias municipais.

Prepramos um pequeno vídeo que ensina como utilizar o painel. Veja [aqui](https://www.youtube.com/watch?v=KA6tFDrPts8).
