...
dataset_analise <- readRDS("~/Github/siconfi_atendimento_hospitalar/dataset_analise_2021.RDS")



load("~/Github/siconfi_atendimento_hospitalar/dados_auxiliares_2021.RData")
...
-   Entrada moderada: formado por 702 municípios. [Ituporanga-SC](https://cidades.ibge.gov.br/brasil/sc/ituporanga/panorama) é o município que ocupa a posição central do agrupamento[^3]. Seu percentual de atendimentos de paciente de outros municípios é 45% e percentual de saída de pacientes é 29,1%.
-   Saída fraca: formado por 1017 municípios. O município de [Três Marias-MG](https://cidades.ibge.gov.br/brasil/mg/tres-marias/panorama) é o que melhor caracteriza esse grupo. O percentual de saída é 31% e o de entrada é 7%.
-   Saída moderada: para esses casos encontramos 1051 municípios. Aqui temos como ponto central a cidade de [São Luiz-RR](https://cidades.ibge.gov.br/brasil/rr/sao-luiz/panorama) com saída de 65,8% dos pacientes e entrada de 6,7%
-   Saída forte: é o maior grupo, formado por 2799 municípios. A localidade [Vila Propício-GO](https://cidades.ibge.gov.br/brasil/go/vila-propicio/panorama) representa o grupo com 100% de saída de pacientes e 0% de chegada.
...
```{r fig.width=20, fig.height=10, fig.dpi=500}
agrupamento_municipio_cluster<-readRDS("agrupamento_municipio_2020.RDS")
