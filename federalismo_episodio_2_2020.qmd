...
[^6]: Os códigos utilizados, incluindo os processos de captura dos dados das fontes primárias estão disponíveis no [github](https://github.com/tchiluanda/siconfi_atendimento_hospitalar).

### Um pouco sobre o painel

Provavelmente você está lendo esse texto a partir de um painel produzido pela Secretaria do Tesouro Nacional. Além desse material o painel conta com páginas que de uma certa forma permitem localizar os municípios dentro dos quadros analíticos explorados ao longo do texto. Convidamos o leitor para fazer a navegação por entre as abas disponibilizadas, fazer filtros, baixar dados e capturar gráficos para outras ressignficações dos dados sobre atendimentos hospitares no Brasil e suas relações com execuções orçamentárias municipais.
