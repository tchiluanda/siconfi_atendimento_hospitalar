...
No primeiro gráfico vê-se que os centros locais lideram o ranking de quantidade de atendimentos. A soma das populações dos mais de 4000 municípios desse nível hierárquico ajuda a justificar essa posição. Na verdade a combinação de efeito da quantidade de municípios e de população dos municípios explica grande parte do ranking.Na verdade os principais achados encontram-se nos outros dois gráficos.
...
Provavelmente você está lendo esse texto a partir de um painel produzido pela Secretaria do Tesouro Nacional. Além desse material o painel conta com páginas que de uma certa forma permitem localizar os municípios dentro dos quadros analíticos explorados ao longo do texto. É possível ainda que com a evolução das sugestões de usuários novas páginas sejam acrescentadas sem necessariamente haver análises feitas pela equipe da STN. Convidamos o leitor a navegar por entre as abas disponibilizadas, fazer filtros, baixar dados e capturar gráficos para outras ressignficações dos dados sobre atendimentos hospitares no Brasil e suas relações com execuções orçamentárias municipais.
